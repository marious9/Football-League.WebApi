...
namespace Football_League.Data.Migrations
{
    ...
    [Migration("20181116200247_SeededPlayer")]
    partial class SeededPlayer
    {
            ...
            modelBuilder.Entity("Football_League.Models.Domain.Match", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AwayId = 2, AwayScore = 1, Date = new DateTime(2018, 11, 16, 21, 2, 47, 196, DateTimeKind.Local), HostId = 11, HostScore = 7, LeagueId = 1, Round = 1 },
                        new { Id = 2, AwayId = 10, AwayScore = 4, Date = new DateTime(2018, 11, 16, 21, 2, 47, 198, DateTimeKind.Local), HostId = 3, HostScore = 1, LeagueId = 1, Round = 1 },
                        new { Id = 3, AwayId = 9, AwayScore = 3, Date = new DateTime(2018, 11, 16, 21, 2, 47, 198, DateTimeKind.Local), HostId = 4, HostScore = 2, LeagueId = 1, Round = 1 },
                        new { Id = 4, AwayId = 8, AwayScore = 3, Date = new DateTime(2018, 11, 16, 21, 2, 47, 198, DateTimeKind.Local), HostId = 5, HostScore = 3, LeagueId = 1, Round = 1 },
                        new { Id = 5, AwayId = 7, AwayScore = 8, Date = new DateTime(2018, 11, 16, 21, 2, 47, 198, DateTimeKind.Local), HostId = 6, HostScore = 1, LeagueId = 1, Round = 1 }
                    );
                });
            ...
            modelBuilder.Entity("Football_League.Models.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "masensio", AccessFailedCount = 0, ConcurrencyStamp = "b35ad38b-345a-4ba5-988b-a8ad9c0d372b", Email = "marco@asensio.pl", EmailConfirmed = false, Firstname = "Marco", Lastname = "Asensio", LockoutEnabled = false, PasswordHash = "AQAAAAEAACcQAAAAEMnz1mM3f8mrMN3n/5aPSdB0gRFQd2+GEr6/+WfptLdU+frBA3DjqB9V+FwubO5TTg==", PhoneNumberConfirmed = false, TwoFactorEnabled = false, UserName = "marcoAsensio" }
                    );
                });
