...
namespace Football_League.Data.Migrations
{
    ...
    [Migration("20181114203730_SeededData")]
            ...
            modelBuilder.Entity("Football_League.Models.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "masensio", AccessFailedCount = 0, ConcurrencyStamp = "74f76a01-df93-40ac-9ec3-04a93e4f449a", Email = "marco@asensio.pl", EmailConfirmed = false, Firstname = "Marco", Lastname = "Asensio", LockoutEnabled = false, PasswordHash = "Asdf1234!", PhoneNumberConfirmed = false, TwoFactorEnabled = false, UserName = "marcoAsensio" }
                    );
                });
